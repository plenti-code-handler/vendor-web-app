...
const Page = () => {
  ...
  return (
    <div className="text-[75%] md:text[90%] lg:text-[100%] bg-[#F5F5F5]">
      <div className="flex flex-col items-center gap-10 p-[5%] lg:px-[2%] lg:pt-[3%] lg:pb-[5%]">
        <div className="flex flex-col gap-4 items-center">
          ...
          <p className="font-semibold text-[1em] text-center w-[100%] md:w-[80%]">
            ...
            what's in the Pouch until you pick it up, which makes the experience
            both exciting and sustainable. Each Pouch is filled with a mixture
      ...
      <Steps
        steps={steps}
        heading={"Here's how surprise pouches works - step by step:"}
...
const steps = [
  ...
  {
    title: "Prepare the pouch for pickup:",
    description:
      "Prepare the bags with the leftover products specified in the app. The Pouches must be ready for collection at the time specified for the customers.",
  },
  {
    title: "Customers collect their pouches:",
    description:
  ...
  },
  {
    ...
    description:
      "By selling surprise bags, you reduce food waste, attract new customers and increase your revenue from products that would otherwise have been lost. Each Pouch sold also contributes to reducing CO2 emissions, making a positive impact on the environment.",
  },
];

const faqData = [
  {
    question: "How does the surprise pouches for companies work?",
    answer:
      "Businesses can sell their leftover, but still fully edible items by creating surprise bags in the FoodieFinder app. You post available Pouches, set collection times, and customers reserve and collect their Pouches from you.",
  },
  {
  ...
  {
    question: "What does my company gain from using the surprise Pouch?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Prepare the pouches according to the information you have entered in the app. When customers come to pick up their crates, they show their confirmation from the app, and you give them the crates.",
  },
  {
    question: "What happens if no customers reserve my pouches?",
    answer:
      "If cash registers are not reserved, your business is not negatively affected; you still tried to reduce food waste. We recommend that you adjust the number of Pouches or the price to better match demand.",
  },
  {
    question: "Can customers see what is in the surprise Pouch?",
    answer:
