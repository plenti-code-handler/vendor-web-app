    ...
    <div className="bg-[#F5F5F5] py-10">
      <div className="mx-14">
        <div className="text-center w-[60%] mx-auto">
          <h1 className="text-[48px] text-[500] text-pinkBgDark">
            Terms & Conditions
          </h1>
        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-14 relative mb-24 w-[60%]">
            <div>
              <h2
              ...
              <p className={`${montserratFont.className} leading-7`}>
                ...
                dolore ut. Est ullam et excepturi eum. Quas a qui modi aut qui.
                Distinctio autem amet ipsum <br />
                <br />
                ...
                eum. Quas a qui modi aut qui. Distinctio autem amet ipsum illum
                qui dolore repellendus tempora. Repellat velit doloribus et
                aspernatur perferendis voluptatibus commodi adipisci ut. Ut sed
                ea vitae dolore ut. Est ullam et excepturi eum. Quas a qui modi
                aut qui. Distinctio <br /> <br />
                <br /> autem amet ipsum illum qui dolore repellendus tempora.
                Repellat velit doloribus et aspernatur perferendis voluptatibus
                commodi adipisci ut.Ut sed ea vitae dolore ut. Est ullam et
                excepturi eum. Quas a qui modi aut qui. Distinctio autem amet
                ipsum illum qui dolore repellendus tempora. Repellat velit
                doloribus et aspernatur perferendis voluptatibus commodi
                adipisci ut. Ut sed ea vitae dolore ut. Est ullam et excepturi
                eum. Quas a qui modi aut qui. Distinctio autem amet ipsum illum
                qui dolore repellendus tempora. Repellat velit doloribus et
                aspernatur perferendis voluptatibus commodi adipisci ut.
              </p>
            </div>
            <div>
              <h2
            ...
            <div>
              ...
              <p className={`${montserratFont.className} leading-7`}>
                ...
                voluptatem esse ut dolores. Numquam quod voluptas ut optio autem
                rerum. Vitae inventore molestiae eaque deserunt aliquid laborum.
                Veniam recusandae quo natus alias. Quibusdam eligendi vitae
                explicabo non sint aliquid.
              </p>
            </div>
            <div>
              <h2
