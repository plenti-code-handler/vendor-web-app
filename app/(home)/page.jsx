  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row pt-5 pb-5 justify-between px-10">
        ...
        <div className="flex flex-col w-full lg:w-[60%] bg-white lg:h-[85vh] max-h-[800px] rounded-[24px] items-center justify-center lg:justify-between shadow-lg overflow-hidden mt-20">
