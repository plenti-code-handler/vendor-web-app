          ...
          <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
            ...
            {orderData && (
              <div className="shrink-0 px-6 py-3 border-b border-gray-100 space-y-2">
                <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-2">Order Details</h3>
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <OrderStatusBadge status={orderData.current_status} />
                  <span
                    className="text-[10px] text-gray-400 font-mono truncate max-w-[55%]"
            ...
            {loadingDetails ? (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1 space-y-1">
                      <div className="flex flex-wrap items-center gap-x-1.5 gap-y-0.5 text-sm leading-snug">
                        <span className="font-medium text-gray-900">{itemTypeLabel}</span>
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        <span className="font-medium text-[#5F22D9]">Best by {bestBefore}</span>
                      </p>
                    </div>
                  </div>
                  );
              ...
              <p className="flex h-full min-h-[12rem] items-center justify-center text-center text-gray-500">
