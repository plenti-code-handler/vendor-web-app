...
const CreateOutletModal = ({ open, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("New outlet created successfully!");
      ...
      <div className="fixed inset-0 flex items-start justify-center overflow-y-auto pt-6">
        ...
        >
          <div className="flex items-center justify-between px-4 pb-2 border-b border-gray-100">
            <h2 className="text-lg font-semibold">Create new outlet</h2>
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. new_outlet_username"
