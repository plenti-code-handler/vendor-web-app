...
const AccountApprovedContent = () => {
    ...
    useEffect(() => {
        ...
        attemptActivation();
    }, [vendorData?.is_active, hasAttemptedActivation, isActivating, dispatch, activationStatus]);
        ...
        <div className="w-full max-w-md py-10">
            ...
            <div className="flex justify-center mb-6">
                <div className="relative">
                    <div className={`w-20 h-20 rounded-full flex items-center justify-center transition-all duration-500 ${showSuccess ? 'bg-green-100 scale-110' : showError ? 'bg-orange-100' : 'bg-purple-100'
                        }`}>
                        {showSuccess ? (
            ...
            <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed text-sm">
                    {showSuccess
                        ? "Congratulations! Your Plenti account has been activated. You can now access your dashboard."
                        : showError
...
export default AccountApprovedContent;
