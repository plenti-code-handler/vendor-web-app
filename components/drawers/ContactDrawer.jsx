      ...
      <div className="fixed inset-0 overflow-hidden rounded-md">
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-4">
            <DialogPanel
              transition
              className="pointer-events-auto relative lg:w-screen max-w-[960px] transform transition duration-500 ease-in-out data-[closed]:translate-x-full sm:duration-700"
            >
              <div className="flex h-full flex-col overflow-y-scroll bg-white py-5 shadow-xl">
                <div className="mx-10 flex flex-col gap-8">
                  <div className="flex justify-between items-center">
                    <h1 className="text-[#404146] text-[30px] font-[500]">
                      Contact Us
                    </h1>
                  ...
                  <p>
                    Molestiae id cumque ut fugit. Doloremque maiores voluptatem
                    sint porro. Voluptates rem voluptates ipsa deleniti vero
                    quia deleniti illum. Vero laudantium debitis sunt veritatis.
                    Iure molestias maxime est et cupiditate. Et dolorem qui
                    ullam est ipsum.
                  </p>
                  <hr className="w-1/2 " />
                  <div className="flex font-[400] text-[24px] items-center justify-between">
